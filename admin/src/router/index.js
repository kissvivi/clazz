...
export const asyncRouterMap = [
  {
    ...
    children: [{
      path: 'list',
      name: '班级管理',
      component: _import('clazz/list'),
      meta: { permission: ['clazz:list'] }
    }]
  },
  {
    path: '/student',
  ...
  },
  {
    path: '/testBank',
    component: Layout,
    redirect: '/testBank/list',
    icon: 'testBank',
    noDropDown: true,
    children: [{
      path: 'list',
      name: '题库',
      component: _import('testBank/list'),
      meta: { permission: ['testBank:list'] }
    }]
  },
  {
    path: '/tests',
