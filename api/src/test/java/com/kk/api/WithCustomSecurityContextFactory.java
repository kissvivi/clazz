...
public class WithCustomSecurityContextFactory
    implements WithSecurityContextFactory<com.kk.api.WithCustomUser> {
  @Resource private AccountDetailsServiceImpl accountDetailsService;

  @Override
  public SecurityContext createSecurityContext(final com.kk.api.WithCustomUser customUser) {
